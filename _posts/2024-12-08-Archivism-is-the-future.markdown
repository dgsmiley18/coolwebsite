...
It is actually easy and i gonna show you how i do.
...
```
there are others cool commands for yt-dlp, i recommend to read the documentation [here](https://github.com/yt-dlp/yt-dlp?tab=readme-ov-file#usage-and-options)

# Images/Arts
if you gonna download single images you can use ``wget IMAGE_URL``
...
And there is more, after downloading the website you can upload the snapshot automaticaly to wayback machine!
